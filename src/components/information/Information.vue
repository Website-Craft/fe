<template>
  <div class="p-4 xl:p-8 bg-black/30 rounded-2xl">
...
<style scoped>
/* From Uiverse.io by Amanfrom2005 */
.button-container {
  cursor: pointer;
  border: none;
...
.b-m-container {
  ...
  -webkit-mask-image: linear-gradient(-75deg, rgb(0 0 0) 30%, #000 50%, rgba(0, 0, 0, 0.2) 70%);
