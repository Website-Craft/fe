<template>
  <div
    class="website-introduction mt-8 rounded-md bg-[var(--color-beige-base)] text-[var(--color-black)] pt-16 pb-8 px-4 sm:px-6 lg:px-8"
  >
...
// Logic cho WebsiteIntroduction nếu cần
</script>
